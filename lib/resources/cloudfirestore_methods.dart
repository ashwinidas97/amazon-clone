  ...
  Future uploadNameAndAddressToDatabase(
    ...
    if (image != null && productName != "" && rawCost != "") {
      try {
        ...
        String url = await uploadImageToDatabase(image: image, uid: Utils().getUid());  
  ...
  Future uploadReviewDatabase(
    ...
    Future changeAverageRating(
      ...
      DocumentSnapshot snapshot = 
        await firebaseFirestore.collection("product").doc(productUid).get();
      ProductModel model = 
